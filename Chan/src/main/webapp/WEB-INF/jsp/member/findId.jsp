...
<body class="text-center">
		...
		<div id="loginBox">
			...
			<div id="inputBox">
				...
				<div class="button-login-box">
					<button type="button" class="btn btn-primary btn-xs" onclick="findIdChk()" style="width:100%">아이디 찾기</button>
				</div>
			</div>
	...
	<form name="findIdForm" id="findIdForm" action="/findIdChk" method="post">
	...
	function findIdChk() {
		...
		if(name == null || name == '') {
			...
			$('#findIdForm [name="name"]').val(name);
			$('#findIdForm [name="birth"]').val(birth);
			$('#findIdForm [name="tel1"]').val(tel1);
			$('#findIdForm [name="tel2"]').val(tel2);
			$('#findIdForm [name="tel3"]').val(tel3);
			$('#findIdForm [name="email1"]').val(email1);
			$('#findIdForm [name="email2"]').val(email2);
			$("#findIdForm").submit();
		}
	}
</script>
